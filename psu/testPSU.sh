cd../ amd64.gmu / sh script.sh cd../
        psu

            g++ -
    std = c++ 11 - O3 - mavx2 - msse2 - maes -
          o PSU main.cc../ maths / utils.cpp../ PAHE / PAHE.cpp../ PAHE /
              RandomGenerator.cpp../ PAHE / PAHEHelper.cpp../ maths /
              HashInput.cpp -
          lssl - lntl - lgmp - lpthread -
          lcrypto../
              fastMod
                  .a

                      rm../
              amd64.gmu / mult.o rm../ fastMod.a
