...
__int128_t mod_slow_p1(__int128_t x) {
  __int128_t y = ((__int128)4611686018427494401ULL << 20) + (x & 0x3FFFFFFFFFFFFFFF) - 106497ULL*(x >> 62) ;
...
__int128_t mod_slow_p2(__int128_t x) {
  __int128_t y = ((__int128)4611686018428010497ULL << 20) + (x & 0x3FFFFFFFFFFFFFFF) - 622593ULL*(x >> 62) ;
