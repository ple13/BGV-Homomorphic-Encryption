...
public:
  ...
  vector<uint64_t> ntt_forward_plaintext(
  ...
  vector<vector<uint64_t>> ntt_inverse_ciphertext(vector<vector<uint64_t>>& data);
  vector<vector<uint64_t>> ftt_forward_ciphertext(vector<vector<uint64_t>>& data);
  vector<vector<uint64_t>> ftt_inverse_ciphertext(vector<vector<uint64_t>>& data);
